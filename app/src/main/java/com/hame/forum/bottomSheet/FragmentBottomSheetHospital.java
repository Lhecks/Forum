...
public class FragmentBottomSheetHospital extends BottomSheetDialogFragment {
    ...
    public static FragmentBottomSheetHospital newInstance(int itemCount) {
        final FragmentBottomSheetHospital fragment = new FragmentBottomSheetHospital();
...
//            super(inflater.inflate(R.layout.fragment_bottom_sheet, parent, false));
